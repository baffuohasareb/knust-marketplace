...
export const mockProducts: Product[] = [
  {
    ...
    description:
      "High-quality wireless headphones perfect for studying and entertainment",
    price: 150,
    images: [
  ...
  },
  {
    ...
    sku: "JRC-001",
    tags: ["jollof", "rice", "chicken", "ghanaian"],
    isActive: true,
  ...
  },
  {
    ...
    tags: ["calculator", "engineering", "scientific", "math"],
    isActive: true,
    allowBackorders: false,
    trackQuantity: true,
    isDigital: false,
...
export const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Excellent service! Fast delivery and great quality products. Highly recommend TechHub Electronics.",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Good headphones for the price. Sound quality is decent and battery life is impressive.",
...
export const mockMessages: ChatMessage[] = [
  {
    ...
    receiverId: "1",
    message:
      "Hi, I'm interested in the Bluetooth headphones. Are they still available?",
  ...
  },
  {
    ...
    receiverId: "1",
    message:
      "Hello! Yes, they are available. We have them in black, white, and blue colors.",
...
export const mockUserBusinesses: VendorBusiness[] = [
  {
    ...
    description:
      "Laptop repairs, phone accessories, and tech support for students",
    logo: "https://images.pexels.com/photos/356056/pexels-photo-356056.jpeg?auto=compress&cs=tinysrgb&w=200",
    businessType: "both",
...
export const mockVendorProducts: VendorProduct[] = [
  {
    ...
    description:
      "Professional laptop screen replacement service with 6-month warranty",
    price: 250,
    images: [
      "https://images.pexels.com/photos/356056/pexels-photo-356056.jpeg?auto=compress&cs=tinysrgb&w=400",
      "https://images.pexels.com/photos/1036622/pexels-photo-1036622.jpeg?auto=compress&cs=tinysrgb&w=400",
    ...
    isActive: true,
    sku: "LSR-001",
    tags: ["laptop", "repair", "screen", "warranty"],
    allowBackorders: false,
    trackQuantity: true,
    isDigital: false,
  ...
  },
  {
    ...
    tags: ["phone", "case", "iphone", "protective"],
    allowBackorders: true,
    trackQuantity: true,
    isDigital: false,
    requiresShipping: true,
  ...
  },
  {
    ...
    description:
      "One-on-one mathematics tutoring session for engineering students",
    price: 20,
    images: [
      "https://images.pexels.com/photos/159751/book-address-book-learning-learn-159751.jpeg?auto=compress&cs=tinysrgb&w=400",
    ],
    ...
    isActive: true,
    sku: "MT-1H-001",
    tags: ["tutoring", "mathematics", "engineering", "education"],
    allowBackorders: true,
    trackQuantity: true,
    isDigital: true,
    requiresShipping: false,
