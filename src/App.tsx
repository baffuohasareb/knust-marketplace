...
import { initializeStoreData } from "./data/mockData";
...
function AppContent() {
  ...
  useEffect(() => {
    const mockData = initializeStoreData();
    setBusinesses(mockData.businesses);
    setProducts(mockData.products);
  }, [setBusinesses, setProducts]);
    ...
    <Router>
      <div className="min-h-screen bg-gray-50">
        ...
        <Routes>
          ...
          <Route
            path="/vendor/onboarding/contact"
            element={
              <ProtectedRoute>
          ...
          <Route
            path="/vendor/onboarding/preview"
            element={
              <ProtectedRoute>
          ...
          <Route
            path="/vendor/:vendorId/products/add"
            element={
              <ProtectedRoute>
                <AddProductPage />
              </ProtectedRoute>
                ...
                <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      This feature will display your order history
                    </p>
                    <a
                      href="/buyer/home"
              ...
              <ProtectedRoute>
                <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      This feature will display your profile information
                    </p>
                    <a
                      href="/buyer/home"
                      className="text-green-600 hover:text-green-700"
